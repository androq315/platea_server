...
INSERT INTO `direccion` VALUES (1,'Carrera 88a'),(2,''),(3,'Cra 2 #79-18 sur'),(4,''),(5,'Cra 2 #79-18 sur'),(6,'Cra 2 #79-18 sur'),(7,'Cra 2 #79-18 sur'),(8,'Cra 2 #79-18 sur'),(9,'Cra 2 #79-18 sur'),(10,'Cra 2 #79-18 sur'),(11,'Cra 2 #79-18 sur'),(12,'Cra 2 #79-18 sur'),(13,'Cra 2 #79-18 sur'),(14,'Cra 2 #79-18 sur'),(15,'calle127D95a77');
...
INSERT INTO `pedido` VALUES (15,20,15,1,'2024-10-19 22:53:54','Pendiente',615005.00,NULL,NULL);
...
INSERT INTO `pedidoproducto` VALUES (7,24,45),(7,32,1),(8,24,1),(9,26,67),(10,26,67),(10,33,1),(11,24,1),(11,25,1),(12,24,1),(12,25,1),(13,24,1),(13,26,1),(14,32,10),(14,36,1),(15,14,1),(15,21,1),(15,36,1);
...
INSERT INTO `persona` VALUES (20,'ANDRES','SUAREZ','anuelaaa549@gmail.com',' ',_binary '\�\\�V�\�s\�-C)\�W��3y�<��Y��\\���Ί]�I(\�\�\�t�z\�\�2����E��S\��?�\�',1,'2147483647','./uploads/img/persona_avatar/descarga_1726785209057.jpeg','http://localhost:4000/./uploads/img/persona_avatar/descarga_1726785209057.jpeg','./uploads/img/banner/gatito_1726785209061.gif','http://localhost:4000/./uploads/img/banner/gatito_1726785209061.gif',2),(21,'ANDRES','MEZA','andresf@gmail.com',NULL,_binary ' U  VJ !)  gg k $~N Sr!Mz@[^o  U ̘RH   4  ( J % ',1,'2147483647',NULL,NULL,NULL,NULL,2),(22,'DANNER','ARIAS','danner@info.com',NULL,_binary 'O\�֯�0\�D��Uθ	n[pV�\�o7�\�8[\�\�U\"NvOM�.+�\�T\r���-p�[\�\�ϡ\�=��\�\�',1,'2147483647',NULL,NULL,NULL,NULL,3);
...
BEGIN
    SELECT 
        P.IdPedido,
        D.Direccion,  -- Cambiamos P.Direccion por D.Direccion
        P.FechaPedido,
        P.EstadoPedido,
        P.Total,
    ...
    LEFT JOIN 
        direccion D ON P.IdDireccionFK = D.id  -- Añadimos la relación con la tabla direccion
    WHERE 
        P.IdPersonaFK = _Id
    GROUP BY 
        P.IdPedido;
...
-- Dump completed on 2024-10-19 17:55:40
