...
class TiendaController {
	...
	static async pedidosTienda(req, res) {
		try {
			const id = req.params.id;
			const pedidos = await Tienda.pedidosTienda(id);
	...
	static async productospedidosTienda(req, res) {
		try {
			const IdTienda = req.params.IdTienda;
			const IdPedido = req.params.IdPedido;
			console.log(IdTienda,' ', IdPedido)
			const productos = await Tienda.productospedidosTienda(IdTienda,IdPedido);
